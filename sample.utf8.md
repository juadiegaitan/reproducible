...
date: "Last update: 25 October, 2016" 
output:
  html_document:
    toc: true
    toc_float:
...
<img src="sample_files/figure-html/some_jitter_plot-1.png" title="" alt="" width="672" />
...
##  [1] Rcpp_0.12.4.5    digest_0.6.9     plyr_1.8.3       grid_3.3.1      
##  [5] gtable_0.2.0     formatR_1.3      magrittr_1.5     evaluate_0.9    
##  [9] scales_0.4.0     highr_0.5.1      stringi_1.0-1    rmarkdown_0.9.6 
## [13] labeling_0.3     tools_3.3.1      stringr_1.0.0    munsell_0.4.3   
## [17] yaml_2.1.13      colorspace_1.2-6 htmltools_0.3.5  methods_3.3.1
```
